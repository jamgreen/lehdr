...
**Upgrading from lehdr < 1.2.0?** Earlier versions cached files without a
version prefix (e.g., `md_wac_S000_JT00_2019.csv.gz`). Those files will
never be matched by the new naming scheme and can be safely deleted. To
